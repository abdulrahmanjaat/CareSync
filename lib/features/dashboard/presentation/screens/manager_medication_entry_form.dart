...
/// Manager Medication Entry Form - Full medication details (same as patient form)
class ManagerMedicationEntryForm extends ConsumerStatefulWidget {
  final Patient patient;

  const ManagerMedicationEntryForm({super.key, required this.patient});

  @override
  ConsumerState<ManagerMedicationEntryForm> createState() =>
      _ManagerMedicationEntryFormState();
}

class _ManagerMedicationEntryFormState
    extends ConsumerState<ManagerMedicationEntryForm> {
